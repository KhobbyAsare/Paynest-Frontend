    ...
    if (!closure) {
        return (
            <div className="flex flex-col items-center justify-center py-24 bg-white rounded-3xl border border-slate-100 shadow-sm">
                ...
                <h3 className="text-2xl font-semibold text-slate-800">No active closure found</h3>
                <p className="text-slate-500 mt-2 max-w-sm text-center">
                    You haven&apos;t started a daily closure yet. Open one to begin tracking today&apos;s financial records.
                </p>
                <Button
                    onClick={onOpenModal}
                    size="lg"
                ...
                >
                    <Plus className="mr-2 h-5 w-5" /> Open First Closure
                </Button>
            </div>
        );
    }
