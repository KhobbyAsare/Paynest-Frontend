            ...
            <div className="flex flex-col items-center justify-center py-24 bg-white rounded-3xl border border-slate-100 shadow-sm">
                ...
                <div className="flex items-center gap-4 mt-8">
                    <Button
                        ...
                        variant="outline"
                        size="lg"
                        className="rounded-xl px-8 border-slate-200 hover:bg-slate-50 font-bold"
                    >
                    ...
                    <Button
                        onClick={onOpenModal}
                        size="lg"
                        className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl px-8 shadow-lg shadow-primary/20 transition-all font-bold"
                    >
