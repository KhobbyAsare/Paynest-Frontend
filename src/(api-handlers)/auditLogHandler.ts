...
export const getAllAuditLogs = async (organization_id: number, user_id: number, action: string, entity_type: string, entity_id: string, limit: number, offset: number): Promise<AuditLogResponse[]> => {
